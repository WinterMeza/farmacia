...
<div id="main-wrapper">
  <div class="unix-login">
    ...
    <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/lg.jpg');
 background-color: #ffffff;background-size:cover">
      <div class="row ">
        <div class="col-md-4">
          <div class="login-content ">
            <div class="login-form">
              <center><img src="./assets/uploadImage/Logo/imgp.jpg" style="width: 200px;"></center><br>
...
<footer class="bg-primary text-white text-center text-lg-start fixed-bottom">
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
   Winter Meza- 9noA - TECNOLOGIAS DE LA INFORMACIÓN EMERGENTES.
  </div>
  <!-- Copyright -->
</footer>
</div>
